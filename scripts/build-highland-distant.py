...
report={}
for region,source in [('highland-farms','Highland_Farms_Trails.blend')]:
...
(ROOT/'docs/highland-distant-budget.json').write_text(json.dumps(report,indent=2),encoding='utf-8')
