...
export class MeteorArrival {
 ...
 position(landing:Vec3,yaw:number):Vec3 {const height=this.height;return {x:landing.x-Math.sin(yaw)*height*.12,y:landing.y+height,z:landing.z-Math.cos(yaw)*height*.12};}
